...
if __name__ == '__main__':
    ...
    # Input dir
    parser.add_argument('-id', '--input_dir',           type=str,   help='Directory contains ONNX files', required=False)
    ...
    weight_paths = glob(f"{args.input_dir}/**/*.ckpt", recursive=True) #+ glob(f"{args.input_dir}/*/*.ckpt")
    ...
    for weight_path in weight_paths:
        ...
        command = f"python eval.py -c {config_path}"
