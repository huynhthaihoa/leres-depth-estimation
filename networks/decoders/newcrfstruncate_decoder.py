...
from ..class_utils import Interpolate, FTB, FFM, NeWCRFsDispHead
            
class NeWCRFsTruncateDecoder(nn.Module):
    def __init__(self, in_channels, mid_channel=0, interpolate=False):
        ...
        """        
        super(NeWCRFsTruncateDecoder, self).__init__()
        ...
        self.disp = NeWCRFsDispHead(input_dim=self.midchannels[-3])
