...
from ..class_utils import FTB, FFMDeConv, NeWCRFsDeconvUpsampleDispHead
            
class NeWCRFsDeconvUpsampleTruncateDecoder(nn.Module):
    def __init__(self, in_channels, mid_channel=0):
        """Metric Decoder, which is customized from LeReS decoder for
        a metric depth model
        """        
        super(NeWCRFsDeconvUpsampleTruncateDecoder, self).__init__()
        ...
        self.disp = NeWCRFsDeconvUpsampleDispHead(input_dim=self.midchannels[-3])
