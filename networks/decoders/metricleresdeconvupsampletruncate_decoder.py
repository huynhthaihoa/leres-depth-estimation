...
class MetricLeResDeConvUpsampleTruncateDecoder(nn.Module):
    def __init__(self, in_channels, mid_channel=0, interpolate=False):
        ...
        """        
        super(MetricLeResDeConvUpsampleTruncateDecoder, self).__init__()
    ...
    def forward(self, features):
        ...
        return self.outconv(x_4)  # original size
