...
class PixelFormerDecoder(nn.Module):
    def __init__(self, in_channels, max_depth, mid_channel=0, interpolate=False):
        """Metric Decoder, which is customized from LeReS decoder for
        a metric depth model
        """        
        super(PixelFormerDecoder, self).__init__()
    ...
    def forward(self, features):
        ...
        x = self.disp_head1(x_2, bin_centers, 2)
        return x
