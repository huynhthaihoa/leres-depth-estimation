...
class MetricLeResBatchNormDecoder(nn.Module):
    def __init__(self, in_channels, interpolate=False):
        ...
        """        
        super(MetricLeResBatchNormDecoder, self).__init__()
        ...
        self.outconv = MetricAOBatchNorm(inchannels=self.midchannels[0], outchannels=self.outchannels, interpolate=interpolate)
