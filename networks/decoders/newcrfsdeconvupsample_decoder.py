...
class NeWCRFsDeconvUpsampleDecoder(nn.Module):
    def __init__(self, in_channels, mid_channel=0):
        ...
        self.disp = NeWCRFsDeconvUpsampleDispHead(input_dim=self.midchannels[0])
