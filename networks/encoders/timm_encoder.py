...
class timmEncoder(BaseEncoder):
    ...
    """    
    def __init__(self, architecture, pretrained=True, finetune=False, out_dimList = [64, 128, 256, 512, 1024], use_5_feat=False, replace_gelu=False, input_width=640, input_height=480):
        ...
        image = torch.randn((1, 3, input_height, input_width))
