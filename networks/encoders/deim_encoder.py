...
class DEIM(BaseEncoder):
    def __init__(
        ...
        if architecture == 'deim_s':
            ...
            #     model_path = 'https://github.com/Peterande/storage/releases/download/dfinev1.0/dfine_s_obj365.pth'
            # elif architecture.startswith('coco') is True:
            #     model_path = 'https://github.com/Peterande/storage/releases/download/dfinev1.0/dfine_s_coco.pth'
            # else:
            #     model_path = 'https://github.com/Peterande/storage/releases/download/dfinev1.0/PPHGNetV2_B0_stage1.pth'
            #     is_stage_backbone = True
            
        elif architecture == 'deim_m':
            ...
            # elif architecture.startswith('object365') is True:
            #     model_path = 'https://github.com/Peterande/storage/releases/download/dfinev1.0/dfine_m_obj365.pth'
            # elif architecture.startswith('coco') is True:
            #     model_path = 'https://github.com/Peterande/storage/releases/download/dfinev1.0/dfine_m_coco.pth'
            # else:
            #     model_path = 'https://github.com/Peterande/storage/releases/download/dfinev1.0/PPHGNetV2_B2_stage1.pth'
            #     is_stage_backbone = True
            
        elif architecture == 'deim_l':
            ...
            # elif architecture.startswith('object365') is True:
            #     model_path = 'https://github.com/Peterande/storage/releases/download/dfinev1.0/dfine_l_obj365.pth'
            # elif architecture.startswith('coco') is True:
            #     model_path = 'https://github.com/Peterande/storage/releases/download/dfinev1.0/dfine_l_coco.pth'
            # else:
            #     model_path = 'https://github.com/Peterande/storage/releases/download/dfinev1.0/PPHGNetV2_B4_stage1.pth'
            #     is_stage_backbone = True

        elif architecture == 'deim_x':  
            ...
            # elif architecture.startswith('object365') is True:
            #     model_path = 'https://github.com/Peterande/storage/releases/download/dfinev1.0/dfine_x_obj365.pth'
            # elif architecture.startswith('coco') is True:
            #     model_path = 'https://github.com/Peterande/storage/releases/download/dfinev1.0/dfine_x_coco.pth'
            # else:
            #     model_path = 'https://github.com/Peterande/storage/releases/download/dfinev1.0/PPHGNetV2_B5_stage1.pth'
            #     is_stage_backbone = True
