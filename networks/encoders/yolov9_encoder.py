...
class YOLOv9(BaseEncoder):
    ...
    def __init__(self, 
        ...
        if architecture == 'yolov9-c':
            ...
            cfg = 'networks/encoders/yolov9/config/yolov9-t.yaml'
            self.reverse = True
        elif architecture == 'yolov9-s':
            cfg = 'networks/encoders/yolov9/config/yolov9-s.yaml'
            self.reverse = True
        ...
        if pretrained:
            ...
            dst = self.state_dict()
            src = torch.load(ckpt_name, 'cpu', weights_only=False)['model'].state_dict()            
            ckpt = {}
