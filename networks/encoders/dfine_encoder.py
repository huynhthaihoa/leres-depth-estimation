...
class DFINE(BaseEncoder):
    def __init__(
        ...
        if architecture.endswith('dfine_s') is True:
        ...
        elif architecture.endswith('dfine_m') is True:
        ...
        elif architecture.endswith('dfine_l') is True:
        ...
        elif architecture.endswith('dfine_x') is True:  
