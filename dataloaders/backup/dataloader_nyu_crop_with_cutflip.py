...
class DataLoadPreprocess(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        if self.mode == "train":
            ...
            image, depth_gt = self.augment_with_cut(image, depth_gt)
    ...
    def augment_with_cut(self, image, depth):
        
        # choose cut option
        choice = random.choice(cut_choices)
        if choice == "depth":
            return self.cut_depth(image, depth)
        elif choice == "flip":
