...
class DataLoadPreprocess(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        if self.mode == "train":
            ...
            # cut_opt = random.choice(cut_opts)
            # if cut_opt == "depth":
            #     image = self.cut_depth(image, depth_gt)
            # elif cut_opt == "flip":
    ...
    def normalize_image(self, image):
        ...
        # numpy_image = cv2.dnn.blobFromImage(numpy_image, 1 / 128.0, (numpy_image.shape[1], numpy_image.shape[0]), 127.5, False, False)
